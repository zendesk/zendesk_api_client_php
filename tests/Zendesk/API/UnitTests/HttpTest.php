...
class HttpTest extends BasicTest
{
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json');
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', ['check' => 1]);
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', [], 'GET', 'application/x-www-form-urlencoded');
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', [], 'POST');
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', ['check' => 1], 'POST');
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', [], 'PUT');
    ...
    {
        $response = Http::sendRequest($this->client, 'tickets.json', ['check' => 1], 'PUT');
